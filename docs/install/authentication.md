...
| `maxPoolSize` | Controls the maximum number of connections the MongoDB Go driver can maintain in its connection pool. For detailed information about this option, see the section [MongoDB connection string](parameters.md#mongodb-connection-string). |
