...
If you find a bug in {{pcsm.full_name}}, you can submit a report to the [JIRA issue tracker](https://jira.percona.com/projects/PCSM) for {{pcsm.full_name}}.
...
1. Sign in to [JIRA issue tracker](https://jira.percona.com/projects/PCSM). You will need to create an account if you do not have one.
...
If you'd like to submit a code patch, follow the [Contributing guide in {{pcsm.short}} code repository](https://github.com/percona/percona-link-mongodb/blob/main/README.md#contributing). 
...
If you wish to have full control over the documentation process, follow the [Contributing to documentation guide](https://github.com/percona/pscm-docs/blob/main/CONTRIBUTING.md).
