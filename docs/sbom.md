...
A Software Bill of Materials (SBOM) is a machine-readable inventory of every component, library, and OS package included in a software artifact, together with versions, licenses, and dependency relationships.
