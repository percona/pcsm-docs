...
* Percona ClusterSync for MongoDB supports only Replica Set to Replica Set synchronization. The source and target replica sets can have different number of nodes.
...
* Percona ClusterSync for MongoDB is supported on both ARM64 and x86_64 architectures.
