...
- GitHub: The latest SBOM will be placed in the root of the main branch.

- Binaries/Tarballs: An SBOM file will be included in the root directory of the release archive.

- Packages (`.deb/.rpm`): The SBOM file will be placed in a standard documentation directory, such as `/usr/share/doc/`.

- Docker Images: The SBOM will be attached directly to the Docker image as metadata.
